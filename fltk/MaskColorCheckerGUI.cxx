...
static Fl_Image *image_invalidParameters() {
  static Fl_Image *image = new Fl_Pixmap(idata_invalidParameters);
  return image;
}
...
static Fl_Image *image_validParameters() {
  static Fl_Image *image = new Fl_Pixmap(idata_validParameters);
  return image;
}
...
Fl_Menu_Item menu_g_menuBar[] = {
 ...
 {"@fileopen Open", 0x4006f,  (Fl_Callback*)cb_fileopen, 0, 0, (uchar)FL_NORMAL_LABEL, 0, 14, 0},
 {"@filesave Save", 0x40073,  (Fl_Callback*)cb_g_menuItemSave, 0, 0, (uchar)FL_NORMAL_LABEL, 0, 14, 0},
